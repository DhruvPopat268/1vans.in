...
Route::post('/save-web-player', [App\Http\Controllers\Auth\AuthenticatedSessionController::class, 'saveWebPlayer'])->name('save.web.player');
...
// Cron
Route::get('/engineer-attendance/create/absent/holiday/data', [App\Http\Controllers\AttendanceController::class, 'getEngineerAttendance']);
Route::get('/update-holiday-attendance', [App\Http\Controllers\AttendanceController::class, 'updateAttendanceForHoliday']);

Route::get('/test-mails', function () {
    Mail::raw('Test email body', function ($message) {
        $message->to('krutikpatel2309@gmail.com')
                ->subject('Test Email')
                ->from('no-reply@1vans.in');
    });
...
Route::get('proposal/pdf/{id}', [ProposalController::class, 'proposal'])->name('proposal.pdf')->middleware(['XSS', 'revalidate']);
  Route::get('get-sub-attributes/{attributeId}', [\App\Http\Controllers\NameOfWorkController::class, 'getSubAttributes']);


//================================= Invoice Payment Gateways  ====================================//

            Route::get('/equipment/form/{id}/pdf', [\App\Http\Controllers\EquipmentController::class, 'downloadPdf'])->name('equipment.form.downloadPdf');

Route::get('/material/stock/{id}/web/pdf', [\App\Http\Controllers\MaterialAnalysisController::class, 'downloadMaterialPdf'])->name('material.form.downloadPdf');
Route::get('/material/purchase-order/{id}/pdf', [\App\Http\Controllers\MaterialAnalysisController::class, 'downloadMaterialPurchaseOrderPdf'])->name('material.purchase.order.downloadPdf');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('/project-dashboard', [DashboardController::class, 'project_dashboard_index'])->name('project.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
            Route::get('/graph-dashboard', [DashboardController::class, 'graph_dashboard_index'])->name('graph.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
Route::get('/notification/read/{id}', [\App\Http\Controllers\DashboardController::class, 'markAsRead'])->name('notification.read');
Route::delete('/notification/{id}/delete', [App\Http\Controllers\DashboardController::class, 'destroyWebNotification'])->name('notification.delete');
Route::delete('/notifications/delete-all', [DashboardController::class, 'deleteAllNotifications'])->name('notification.deleteAll');
    ...
    Route::post('/profile/update-project', [UserController::class, 'updateProject'])->name('update.project')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    // Other User
            Route::get('other-user', [UserController::class, 'indexotheruser'])->name('other.user.index');
        Route::get('other-user-create', [UserController::class, 'createotheruser'])->name('other.user.create');
    Route::post('other-user-store', [UserController::class, 'storeotheruser'])->name('other.user.store');
            Route::get('other-user/{id}/edit', [UserController::class, 'editotheruser'])->name('other.user.edit');
                    Route::put('other-user/{id}/update', [UserController::class, 'updateotheruser'])->name('other.user.update');
    Route::delete('other-user/{id}/delete', [UserController::class, 'destroyotheruser'])->name('other.user.destroy');
        Route::any('other-user/reset-password/{id}', [UserController::class, 'userPasswordotheruser'])->name('other.user.reset');
    Route::post('other-user/reset-password/{id}', [UserController::class, 'userPasswordResetotheruser'])->name('other.user.reset.password');
                    Route::get('user/import/file', [\App\Http\Controllers\UserController::class, 'importFile'])->name('user.file.import');
    ...
    Route::get('holiday-calender', [HolidayController::class, 'calender'])->name('holiday.calender');
           Route::get('holiday/import/file', [\App\Http\Controllers\HolidayController::class, 'importFile'])->name('holiday.file.import')->middleware(['auth', 'XSS']);
            Route::post('holiday/import', [\App\Http\Controllers\HolidayController::class, 'import'])->name('holiday.import')->middleware(['auth', 'XSS']);
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('project-document', [ProjectController::class, 'projectDocumentindex'])->name('project.document.index');
            Route::get('project-document-create', [ProjectController::class, 'projectDocumentcreate'])->name('project.document.create');
            Route::post('project-document-store', [ProjectController::class, 'projectDocumentstore'])->name('project.document.store');
            Route::get('project-document/{projectDocument}/edit', [ProjectController::class, 'projectDocumentedit'])->name('project.document.edit');
            Route::put('project-document/{id}', [ProjectController::class, 'projectDocumentupdate'])->name('project.document.update');
            Route::get('project-document/{ProjectDocument}', [ProjectController::class, 'projectDocumentshow'])->name('project.document.show');

            Route::post('project-document/{id}/upload', [ProjectController::class, 'projectDocumentfileUpload'])->name('ProjectDocument.file.upload');
            Route::delete('project-document/attachment/{id}', [ProjectController::class, 'projectDocumentdeleteAttachment'])->name('ProjectDocument.attachment.delete');
            Route::get('project-document/{doc_id}/attachment/{attachment_id}/download', [ProjectController::class, 'downloadAttachment'])->name('ProjectDocument.file.download');
                        Route::get('all-project', [ProjectController::class, 'adminprojectindex'])->name('project.superadmin.index');
            Route::post('/projects/send-otp', [ProjectController::class, 'sendOtp'])->name('projects.sendOtp');
Route::post('/projects/verify-otp', [ProjectController::class, 'verifyOtp'])->name('projects.verifyOtp');
    ...
    Route::group(
        [
            ...
            Route::resource('drawings', \App\Http\Controllers\DrawingsController::class);
            Route::post('drawings/{id}/file-upload', [\App\Http\Controllers\DrawingsController::class, 'fileUpload'])->name('drawings.file.upload');
            Route::get('drawings/{drawing}/attachment/{attachment}/download', [\App\Http\Controllers\DrawingsController::class, 'download'])->name('drawings.file.download');
            Route::delete('/drawings/attachments/{attachment}', [\App\Http\Controllers\DrawingsController::class, 'deleteAttachment'])->name('drawings.attachment.delete');
     ...
     Route::group(
        [
            ...
            Route::resource('engineer-attendance', \App\Http\Controllers\AttendanceController::class);
           Route::get('engineer-attendance/{engineer_id}/export', [App\Http\Controllers\AttendanceController::class, 'exportEngineerAttendance'])->name('engineer.attendance.export');
Route::get('engineer-attendance/{engineer_id}/export-pdf', [App\Http\Controllers\AttendanceController::class, 'exportEngineerAttendancePDF'])->name('engineer.attendance.export.pdf');
     ...
     Route::group(
        [
            ...
            Route::resource('material-testing-reports', \App\Http\Controllers\MaterialTestingReports::class);
            Route::get('material-testing-reports-details/create/{reportId}', [\App\Http\Controllers\MaterialTestingReports::class, 'reportsDetailscreate'])->name('material.report.details.create');
            Route::post('material-testing-reports-details/store', [\App\Http\Controllers\MaterialTestingReports::class, 'reportsDetailsstore'])->name('material.report.details.store');
             Route::get('material-testing-reports-details/edit/{material_testing_report_details}', [\App\Http\Controllers\MaterialTestingReports::class, 'reportsDetailsedit'])->name('material.report.details.edit');
            Route::put('material-testing-reports-details/update/{id}', [\App\Http\Controllers\MaterialTestingReports::class, 'reportsDetailsupdate'])->name('material.report.details.update');


            Route::get('bill-of-quantity', [\App\Http\Controllers\MaterialTestingReports::class, 'billofquantityindex'])->name('billOfQuantity.index');
            Route::post('billofquantity/file/upload', [\App\Http\Controllers\MaterialTestingReports::class, 'billofquantityfileUpload'])->name('billofquantity.file.upload');
            Route::get('billofquantity/file/download/{id}', [\App\Http\Controllers\MaterialTestingReports::class, 'download'])->name('billofquantity.file.download');
            Route::delete('billofquantity/file/delete/{id}', [\App\Http\Controllers\MaterialTestingReports::class, 'billOfQuantitydeleteAttachment'])->name('billofquantity.file.delete');
        }
    );
    ...
    Route::group(
        [
            ...
            Route::get('equipments/history', [\App\Http\Controllers\EquipmentController::class, 'historyindex'])->name('equipment.history.index');
            Route::get('equipments/history/details/{equipment_id}', [\App\Http\Controllers\EquipmentController::class, 'historyshow'])->name('equipment.history.show');
 Route::get('equipments/report', [\App\Http\Controllers\EquipmentController::class, 'reportindex'])->name('equipment.report.index');
            Route::get('equipment/form/{id}', [\App\Http\Controllers\EquipmentController::class, 'reportshow'])->name('equipment.report.show');
             Route::get('equipment/report/create', [\App\Http\Controllers\EquipmentController::class, 'reportcreate'])->name('equipment.report.create');
            Route::post('equipment/report/store', [\App\Http\Controllers\EquipmentController::class, 'reportstore'])->name('equipment.report.store');
        }
    );
    ...
    Route::group(
        [
            ...
            Route::resource('material-category', \App\Http\Controllers\MaterialCategoryController::class);
            Route::get('material-subcategory/{id}', [\App\Http\Controllers\MaterialCategoryController::class, 'subcategoryindex'])->name('material.subcategory.index');
            Route::get('material-subcategory/create/{categoryId}', [\App\Http\Controllers\MaterialCategoryController::class, 'subcategorycreate'])->name('material.subcategory.create');
            Route::post('material-subcategory/store', [\App\Http\Controllers\MaterialCategoryController::class, 'subcategorystore'])->name('material.subcategory.store');
              Route::get('/materials-subcategory/edit/{material_sub_category}', [\App\Http\Controllers\MaterialCategoryController::class, 'subcategoryedit'])->name('material.subcategory.edit');
            Route::put('/materials-subcategory/update/{material_sub_category}', [\App\Http\Controllers\MaterialCategoryController::class, 'subcategoryupdate'])->name('material.subcategory.update');
        }
    );
    ...
    Route::group(
        [
            ...
            Route::resource('material-analysis', \App\Http\Controllers\MaterialAnalysisController::class);
             Route::get('/material/incoming/{id}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialIncomingshow'])->name('material.incoming.show');
            Route::get('/materials/incoming/create/{categoryId}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialIncomingcreate'])->name('material.incoming.create');
            Route::post('/materials/incoming/store', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialIncomingstore'])->name('material.incoming.store');
                        Route::get('/materials/incoming/edit/{material_incoming}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialIncomingedit'])->name('material.incoming.edit');
            Route::put('/materials/incoming/update/{material_incoming}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialIncomingupdate'])->name('material.incoming.update');
            
            Route::get('/material/purchase/order/{id}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialPurchaseOrderindex'])->name('material.purchase.order.index');
            Route::get('/material/purchase/order/details/{id}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialPurchaseOrdershow'])->name('material.purchase.order.show');
            Route::get('/materials/purchase-order/create/{categoryId}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialPurchaseOrdercreate'])->name('material.purchase.order.create');
            Route::post('/materials/purchase-order/store', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialPurchaseOrderstore'])->name('material.purchase.order.store');
            Route::get('/materials/purchase-order/edit/{purchase_order}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialPurchaseOrderedit'])->name('material.purchase.order.edit');
            Route::put('/materials/purchase-order/update/{purchase_order}', [\App\Http\Controllers\MaterialAnalysisController::class, 'materialPurchaseOrderupdate'])->name('material.purchase.order.update');
    ...
    //         ],
    //     ], function () {
    //         Route::resource('material-reports', \App\Http\Controllers\MaterialReportsController::class);
    //         Route::get('/material/subcategories', [\App\Http\Controllers\MaterialReportsController::class, 'getSubCategories'])->name('get.subcategories');
    ...
    Route::group(
        [
            ...
            Route::resource('work-issue', \App\Http\Controllers\WorkIssueController::class);
Route::get('work-issue/pdf/{id}', [\App\Http\Controllers\WorkIssueController::class, 'downloaWorkIssuedPdf'])->name('work-issue-data.pdf');
    ...
    Route::group(
        [
            ...
            Route::resource('import-data', \App\Http\Controllers\ImportDataController::class);
Route::post('/import/types-of-work', [\App\Http\Controllers\ImportDataController::class, 'importTypesOfWork'])->name('import.typesOfWork');
Route::post('/import/name-of-works', [\App\Http\Controllers\ImportDataController::class, 'importNameOfWorks'])->name('import.nameOfWorks');
Route::post('/import/working-area-work-section', [\App\Http\Controllers\ImportDataController::class, 'importWorkingAreaWorkSection'])->name('import.WorkingAreaWorkSection');
Route::post('/import/types-of-measurements-unit', [\App\Http\Controllers\ImportDataController::class, 'importTypesOfMeasurementsUnit'])->name('import.TypesOfMeasurementsUnit');
Route::post('/import/types-of-equipment', [\App\Http\Controllers\ImportDataController::class, 'importTypesOfEquipment'])->name('import.typesOfEquipment');
Route::post('/import/material-unit', [\App\Http\Controllers\ImportDataController::class, 'importMaterialUnit'])->name('import.MaterialUnit');
Route::post('/import/types-of-material', [\App\Http\Controllers\ImportDataController::class, 'importTypesofMaterial'])->name('import.TypesofMaterial');
Route::post('/import/types-of-material-sub-category', [\App\Http\Controllers\ImportDataController::class, 'importTypesofMaterialSubCategory'])->name('import.TypesofMaterialSubCategory');
        ...
        [
            ...
            Route::resource('name-of-work', \App\Http\Controllers\NameOfWorkController::class);
     ...
     Route::group(
        [
            ...
            Route::resource('main-category', \App\Http\Controllers\DailyreportMainCategoryController::class);
    ...
    Route::group(
        [
            ...
            Route::resource('unit-category', \App\Http\Controllers\UnitCategoryController::class);
           Route::get('unit-subcategory/{id}', [\App\Http\Controllers\UnitCategoryController::class, 'unitsubcategoryindex'])->name('unit.subcategory.index');
            Route::get('unit-subcategory/create/{categoryId}', [\App\Http\Controllers\UnitCategoryController::class, 'unitsubcategorycreate'])->name('unit.subcategory.create');
            Route::post('unit-subcategory/store', [\App\Http\Controllers\UnitCategoryController::class, 'unitsubcategorystore'])->name('unit.subcategory.store');
            Route::get('unit-subcategory/edit/{unit_sub_category}', [\App\Http\Controllers\UnitCategoryController::class, 'unitsubcategoryedit'])->name('unit.subcategory.edit');
            Route::put('unit-subcategory/update/{unit_sub_category}', [\App\Http\Controllers\UnitCategoryController::class, 'unitsubcategoryupdate'])->name('unit.subcategory.update');
    ...
    Route::group(
        [
            ...
            Route::resource('mesurement-attribute', \App\Http\Controllers\MesurementAttributeController::class);
Route::get('mesurement-subattribute/{id}', [\App\Http\Controllers\MesurementAttributeController::class, 'subAttributeindex'])->name('mesurement.subattribute.index');
            Route::get('mesurement-subattribute/create/{AttributeId}', [\App\Http\Controllers\MesurementAttributeController::class, 'subAttributecreate'])->name('mesurement.subattribute.create');
            Route::post('mesurement-subattribute/store', [\App\Http\Controllers\MesurementAttributeController::class, 'subAttributestore'])->name('mesurement.subattribute.store');
Route::get('mesurement-subattribute/edit/{mesaurement_sub_attribute}', [\App\Http\Controllers\MesurementAttributeController::class, 'subAttributeedit'])->name('mesurement.subattribute.edit');
            Route::put('mesurement-subattribute/update/{mesaurement_sub_attribute}', [\App\Http\Controllers\MesurementAttributeController::class, 'subAttributeupdate'])->name('mesurement.subattribute.update');
        ...
        [
            ...
            Route::resource('man-power', \App\Http\Controllers\ManPowerController::class);
                        Route::get('man-power/edit/data/{man_power}', [\App\Http\Controllers\ManPowerController::class, 'editmanpowerdata'])->name('manpower.data.edit');
            Route::put('man-power/update/data/{man_power}', [\App\Http\Controllers\ManPowerController::class, 'updatemanpowerdata'])->name('manpower.data.update');
    ...
    Route::group(
        [
            ...
            Route::resource('daily-report', \App\Http\Controllers\DailyReportController::class);
Route::get('daily-report/details/{id}', [\App\Http\Controllers\DailyReportController::class, 'showDetail'])->name('daily-report.details');
Route::get('daily-report/pdf/{id}', [\App\Http\Controllers\DailyReportController::class, 'downloaReportdPdf'])->name('daily-report.pdf');
Route::get('daily-all-reports/', [\App\Http\Controllers\DailyReportController::class, 'allreportindex'])->name('all-report.index');
Route::get('/get-flours-by-wing/{wing_id}', [\App\Http\Controllers\DailyReportController::class, 'getFloursByWing'])->name('get.flours.by.wing');
     ...
     Route::group(
        [
            ...
            Route::resource('site-gallery', \App\Http\Controllers\SiteGalleryController::class);
Route::get('site-gallery/video/{id}', [\App\Http\Controllers\SiteGalleryController::class, 'showVideos'])->name('site-gallery.video');
     ...
     Route::group(
        [
            ...
            Route::resource('site-report', \App\Http\Controllers\SiteReportController::class);
Route::get('/site-report/{id}/pdf', [\App\Http\Controllers\SiteReportController::class, 'downloadSiteReportPdf'])->name('site.report.downloadPdf');
     ...
     Route::group(
        [
            ...
            Route::resource('to-do-list', \App\Http\Controllers\ToDoEngineerController::class);
          Route::get('to-do-task/{id}', [\App\Http\Controllers\ToDoEngineerController::class, 'todoTaskindex'])->name('todo.task.index');
            Route::get('to-do-task/create/{todoengId}', [\App\Http\Controllers\ToDoEngineerController::class, 'todoTaskcreate'])->name('todo.task.create');
            Route::post('to-do-task/store', [\App\Http\Controllers\ToDoEngineerController::class, 'todoTaskstore'])->name('todo.task.store');
            Route::get('to-do-task/attachments/{todoengtask}', [\App\Http\Controllers\ToDoEngineerController::class, 'todoTaskshow'])->name('todo.task.show');
    ...
    Route::group(
        [
            ...
            Route::resource('auto-desk', \App\Http\Controllers\AutoDexController::class);
            Route::post('auto-desk/{id}/file-upload', [\App\Http\Controllers\AutoDexController::class, 'fileUploadAutoDex'])->name('auto.desk.file.upload');
            Route::get('auto-desk/{auto_dex}/attachment/{attachment}/download', [\App\Http\Controllers\AutoDexController::class, 'download'])->name('auto.dex.file.download');
            Route::delete('auto-desk/attachment/{id}/delete', [\App\Http\Controllers\AutoDexController::class, 'autoDexdeleteAttachment'])->name('auto.dex.attachment.delete');
Route::post('/attachments/save-viewer-url', [\App\Http\Controllers\AutoDexController::class, 'saveViewerUrl'])->name('drawings.attachment.saveViewerUrl');
     ...
     Route::group(
        [
            ...
            Route::resource('wing', \App\Http\Controllers\WingController::class);
            Route::get('flour/{id}', [\App\Http\Controllers\WingController::class, 'flourindex'])->name('flour.index');
            Route::get('flour/create/{wingId}', [\App\Http\Controllers\WingController::class, 'flourcreate'])->name('flour.create');
            Route::post('flour/store', [\App\Http\Controllers\WingController::class, 'flourstore'])->name('flour.store');
            Route::get('flour/edit/{flour}', [\App\Http\Controllers\WingController::class, 'flouredit'])->name('flour.edit');
            Route::put('flour/update/{flour}', [\App\Http\Controllers\WingController::class, 'flourupdate'])->name('flour.update');
