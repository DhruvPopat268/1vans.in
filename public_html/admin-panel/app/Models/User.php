...
{
    return $this->belongsTo(\App\Models\Project::class, 'project_assign_id');
}
    ...
    public function totalCompanyUser($id)
    {
     ...
     public function totalAppUser($id)
{
    return User::where('created_by', '=', $id)
        ->where('type', 'app user') // or adjust based on your database column
        ->count();
}
...
{
    return User::where('created_by', '=', $id)
        ->where('type', 'client') // or adjust based on your database column
        ->count();
}

public function totalProjectTeam($id)
{
    return User::where('created_by', $id)
        ->whereNotIn('type', ['client', 'super admin', 'accountant','Employee','company','app user']) // exclude these
        ->count();
}

    public function totalCompanyCustomer($id)
    {
        return Project::where('created_by', '=', $id)->count();
    }
