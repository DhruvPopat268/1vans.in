...
class AuthenticatedSessionController extends Controller
{
    ...
    public function __construct()
    {
     ...
     public function saveWebPlayer(Request $request)
{
    if (auth()->check()) {
        $user = auth()->user();
    ...
    public function store(LoginRequest $request)
    {
        ...
        if($user != null && $user->type == 'app user') {
             return redirect()->back()->with('status', __('App User is not allowed to login from here.'));
            }
