...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{Form::label('max_users',__('Maximum Engineer'),['class'=>'form-label'])}}<x-required></x-required>
            {{Form::number('max_users',null,array('class'=>'form-control','required'=>'required' , 'placeholder' => __('Enter Maximum Engineer')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Form::label('max_project',__('Maximum Project'),['class'=>'form-label'])}}<x-required></x-required>
            {{Form::number('max_project',null,array('class'=>'form-control','required'=>'required' , 'placeholder' => __('Enter Maximum Project')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        {{--  <div class="form-group col-md-6">
