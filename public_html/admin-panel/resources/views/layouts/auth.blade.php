...
<body class="{{ $themeColor }}">
    <div class="custom-login" style="background-image: url('{{ env('APP_URL') }}/storage/login_background/login-bg.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
