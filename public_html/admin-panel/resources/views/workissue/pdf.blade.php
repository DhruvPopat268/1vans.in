   ...
   <body>
      ...
      <div class="content">
         ...
         <div class="walkaround-info-box">
            ...
            <tr>
                ...
                <tr>
                  ...
                  <td><strong>Location:</strong> {{ $report->location ?? 'N/A' }}</td>

               </tr>
                <tr>
                  <td><strong>Name Of Work:</strong> {{ $report->name_of_work ?? 'N/A' }}</td>
                  <td><strong>Status:</strong> {{ $report->status ?? 'N/A' }}</td>
               </tr>
               <tr>
                  <td><strong>Issue:</strong> {{ $report->issue }}</td>
                 <td><strong>Created by:</strong> {{ $report->user->name ?? 'N/A' }}</td>
               </tr>
         ...
         <div style="margin-top: 20px;page-break-inside: avoid;">
            <p><strong>Work Issue Images:</strong></p>
         ...
         <div style="text-align: left; margin-top: 20px;">
            <p><strong>Work Issue Images:</strong> Not available</p>
         </div>
         @endif
      </div>
   </body>
