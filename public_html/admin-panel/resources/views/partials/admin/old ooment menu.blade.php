                        ...
                        <li
                            ...
                            @endcan
                             @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project'}}">
                                    <a class="dash-link" href="{{ route('project.document.index') }}">{{ __('Project Documents') }}</a>
                                </li>
                            @endcan
                            @can('manage project')
                                <li
...
-->
                    ...
                    <li
                        class="dash-item dash-hasmenu
                                                {{ Request::segment(1) == 'project'
                                                    ...
                                                    : '' }}">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="fas fa-truck-monster"></i></span><span
                                class="dash-mtext">{{ __('Equipment Manage') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('equipment.index') }}">{{ __('Equipment') }}</a>
                                </li>
                            @endcan
                             @can('manage project')
                            <li
                                class="dash-item  {{ Request::segment(1) == 'project' }}">
                                <a class="dash-link" href="{{ route('equipment.history.index') }}">{{ __('Equipment Summary') }}</a>
                            </li>
                        @endcan
                        @can('manage project')
                            <li
                                class="dash-item  {{ Request::segment(1) == 'project' }}">
                                <a class="dash-link" href="{{ route('equipment.report.index') }}">{{ __('Daily Report') }}</a>
                            </li>
                        @endcan
                 ...
                 @if (Gate::check('manage project'))
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Material Reports') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('attribute.index') }}">{{ __('Attribute') }}</a>
                                </li>
                            @endcan
                            @can('manage project')
                            <li
                                class="dash-item  {{ Request::segment(1) == 'project' }}">
                                <a class="dash-link" href="{{ route('material-category.index') }}">{{ __('Material Category') }}</a>
                            </li>
                        @endcan
                        @can('manage project')
                            <li
                                class="dash-item  {{ Request::segment(1) == 'project' }}">
                                <a class="dash-link" href="{{ route('material-analysis.index') }}">{{ __('Material Analysis') }}</a>
                            </li>
                        @endcan
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext">{{ __('Work Issues') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="dash-submenu">
                        @can('manage project')
                            <li
                                class="dash-item  {{ Request::segment(1) == 'project' }}">
                                <a class="dash-link" href="{{ route('work-issue.index') }}">{{ __('Work Issue') }}</a>
                            </li>
                        @endcan
            ...
            @endif
               ...
               @if (Gate::check('manage project'))
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-report"></i></span><span
                                class="dash-mtext">{{ __('Daily Reports') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                             @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('unit-category.index') }}">{{ __('Category') }}</a>
                                </li>
                            @endcan
                             @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('wing.index') }}">{{ __('Wing') }}</a>
                                </li>
                            @endcan
                            @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('name-of-work.index') }}">{{ __('Name Of Work') }}</a>
                                </li>
                            @endcan
                             @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('mesurement-attribute.index') }}">{{ __('Mesurement Attribute') }}</a>
                                </li>
                            @endcan
                            @can('manage project')
                                <li
                            ...
                            @endcan
                              ...
                              @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('daily-report.index') }}">{{ __('Report') }}</a>
                                </li>
                            @endcan
                              ...
                              @can('manage project')
                                <li
                                    class="dash-item  {{ Request::segment(1) == 'project' }}">
                                    <a class="dash-link" href="{{ route('all-report.index') }}">{{ __('All Report') }}</a>
                                </li>
                            @endcan
                        ...
                        <ul class="dash-submenu">
                            @can('manage user')
                                <li
                                    ...
                                    <a class="dash-link" href="{{ route('users.index') }}">{{ __('Engineer') }}</a>
                                </li>
                            @endcan
-->                            <!--@can('manage role')-->
                            <!--    <li-->
