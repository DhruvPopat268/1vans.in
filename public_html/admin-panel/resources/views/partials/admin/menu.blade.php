...
<div class="navbar-wrapper">
            ...
            <ul class="dash-navbar">
                ...
                @if (Gate::check('show hrm dashboard') ||
                    ...
                    <li
                     ...
                     <li class="dash-item {{ Request::segment(1) == 'project-dashboard' ? 'active' : '' }}">
        <a href="{{ route('project.dashboard') }}" class="dash-link">
    ...
    {{-- Graph Dashboard --}}
    <li class="dash-item {{ Request::segment(1) == 'graph-dashboard' ? 'active' : '' }}">
        <a href="{{ route('graph.dashboard') }}" class="dash-link">
            <span class="dash-micon"><i class="ti ti-chart-pie"></i></span>
            <span class="dash-mtext">{{ __('Graph Dashboard') }}</span>
        </a>
    </li>
                ...
                @if (\Auth::user()->type != 'super admin' && (Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage client') || Gate::check('manage project')))
                    <li
                        ...
                        <a href="#!" class="dash-link "><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Project Setup') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                       ...
                       <!--@can('manage role')-->
                            ...
                            <!--@endcan-->
                             @can('manage project')
                                    <li
                                        class="dash-item  {{ Request::segment(1) == 'project' }}">
                            ...
                            @can('manage client')
                                <li
                                    ...
                                    <a class="dash-link" href="{{ route('clients.index') }}">{{ __('Project Clients') }}</a>
                                </li>
                            @endcan
                                ...
                                <li
                                    ...
                                    <a class="dash-link" href="{{ route('users.index') }}">{{ __('Project Engineers') }}</a>
                                </li>
                            @endcan
                             @can('manage user')
                                <li
                                    class="dash-item">
                                    <a class="dash-link" href="{{ route('roles.index') }}">{{ __('Project Team Roles') }}</a>
                                </li>
                            @endcan
                             @can('manage user')
                                <li
                                    class="dash-item">
                                    <a class="dash-link" href="{{ route('other.user.index') }}">{{ __('Project Teams') }}</a>
                                </li>
                            @endcan
                             @can('manage user')
                                <li
                                    class="dash-item">
                                    <a class="dash-link" href="{{ route('import-data.index') }}">{{ __('Project Team Roles') }}</a>
                                </li>
                            @endcan
                            {{--                                    @can('manage user') --}}
    ...
    <li class="dash-item dash-hasmenu
        {{ Request::is('project.document*') ||
           Request::is('drawings*') ||
           Request::is('billOfQuantity*') ||
           Request::is('material-testing-reports*') ||
           Request::is('auto-desk*')
           ? 'active dash-trigger' : '' }}">

        <a href="#!" class="dash-link">
            <span class="dash-micon"><i class="far fa-file-alt"></i></span>
            <span class="dash-mtext">{{ __('Project Documents') }}</span>
        ...
        <ul class="dash-submenu">
            ...
            @if(($user->type === 'company' && in_array('manage site documents', $webAccess)) || ($user->type !== 'company' && $user->can('manage site documents')))
                <li class="dash-item {{ Request::routeIs('project.document.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('project.document.index') }}">{{ __('Site Documents') }}</a>
                </li>
            @endif

            {{-- Working Drawings --}}
            @if(($user->type === 'company' && in_array('manage working drawings', $webAccess)) || ($user->type !== 'company' && $user->can('manage working drawings')))
                <li class="dash-item {{ Request::routeIs('drawings.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('drawings.index') }}">{{ __('Working Drawings') }}</a>
                </li>
            @endif

            {{-- Bill Of Quantity --}}
            @if(($user->type === 'company' && in_array('manage bill of quantity', $webAccess)) || ($user->type !== 'company' && $user->can('manage bill of quantity')))
                <li class="dash-item {{ Request::routeIs('billOfQuantity.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('billOfQuantity.index') }}">{{ __('Bill Of Quantity') }}</a>
                </li>
            @endif
            ...
            @if(($user->type === 'company' && in_array('manage material testing reports', $webAccess)) || ($user->type !== 'company' && $user->can('manage material testing reports')))
                <li class="dash-item {{ Request::routeIs('material-testing-reports.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('material-testing-reports.index') }}">{{ __('Material Testing Reports') }}</a>
                </li>
            @endif

            {{-- Autocad Files --}}
            @if(($user->type === 'company' && in_array('manage autocad files', $webAccess)) || ($user->type !== 'company' && $user->can('manage autocad files')))
                <li class="dash-item {{ Request::routeIs('auto-desk.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('auto-desk.index') }}">{{ __('Autocad Files') }}</a>
                </li>
            @endif
...
@if(
    ...
    <li class="dash-item dash-hasmenu
        {{ Request::is('main-category*') ||
           Request::is('name-of-work*') ||
           Request::is('wing*') ||
           Request::is('mesurement-attribute*') ||
           Request::is('daily-report*') ||
           Request::is('all-report*') ||
           Request::is('man-power*') ||
           Request::is('import-data*')
           ? 'active dash-trigger' : '' }}">

        <a href="#!" class="dash-link">
            <span class="dash-micon"><i class="ti ti-report"></i></span>
            <span class="dash-mtext">{{ __('Project Management') }}</span>
            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
        </a>
        ...
        <ul class="dash-submenu">
            ...
            @if(($user->type === 'company' && in_array('manage types of work', $webAccess)) || ($user->type !== 'company' && $user->can('manage types of work')))
                <li class="dash-item {{ Request::routeIs('main-category.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('main-category.index') }}">{{ __('Types Of Work') }}</a>
                </li>
            @endif

            {{-- Name Of Works --}}
            @if(($user->type === 'company' && in_array('manage name of works', $webAccess)) || ($user->type !== 'company' && $user->can('manage name of works')))
                <li class="dash-item {{ Request::routeIs('name-of-work.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('name-of-work.index') }}">{{ __('Name Of Works') }}</a>
                </li>
            @endif

            {{-- Working Area --}}
            @if(($user->type === 'company' && in_array('manage working area', $webAccess)) || ($user->type !== 'company' && $user->can('manage working area')))
                <li class="dash-item {{ Request::routeIs('wing.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('wing.index') }}">{{ __('Working Area') }}</a>
                </li>
            @endif
            ...
            @if(($user->type === 'company' && in_array('manage types of measurements', $webAccess)) || ($user->type !== 'company' && $user->can('manage types of measurements')))
                <li class="dash-item {{ Request::routeIs('mesurement-attribute.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('mesurement-attribute.index') }}">{{ __('Types Of Measurements') }}</a>
                </li>
            @endif

            {{-- Work Reports --}}
            @if(($user->type === 'company' && in_array('manage work reports', $webAccess)) || ($user->type !== 'company' && $user->can('manage work reports')))
                <li class="dash-item {{ Request::routeIs('daily-report.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('daily-report.index') }}">{{ __('Work Reports') }}</a>
                </li>
            @endif

            {{-- All Reports --}}
            @if(($user->type === 'company' && in_array('manage all reports', $webAccess)) || ($user->type !== 'company' && $user->can('manage all reports')))
                <li class="dash-item {{ Request::routeIs('all-report.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('all-report.index') }}">{{ __('All Reports') }}</a>
                </li>
            @endif

            {{-- Man Power --}}
            @if(($user->type === 'company' && in_array('manage man power', $webAccess)) || ($user->type !== 'company' && $user->can('manage man power')))
                <li class="dash-item {{ Request::routeIs('man-power.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('man-power.index') }}">{{ __('Man Power') }}</a>
                </li>
            @endif

            {{-- Import Data --}}
            @if(($user->type === 'company' && in_array('manage import data', $webAccess)) || ($user->type !== 'company' && $user->can('manage import data')))
                <li class="dash-item {{ Request::routeIs('import-data.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('import-data.index') }}">{{ __('Import Data') }}</a>
                </li>
            @endif
...
@endif
    ...
    <li class="dash-item dash-hasmenu
        {{ Request::is('equipment*') ? 'active dash-trigger' : '' }}">
        <a href="#!" class="dash-link">
            <span class="dash-micon"><i class="fas fa-truck-monster"></i></span>
            <span class="dash-mtext">{{ __('Equipment Management') }}</span>
            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
        </a>
        <ul class="dash-submenu">
            ...
            @if(($user->type === 'company' && in_array('manage types of equipment', $webAccess)) || ($user->type !== 'company' && $user->can('manage types of equipment')))
                <li class="dash-item {{ Request::routeIs('equipment.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('equipment.index') }}">
                        {{ __('Types Of Equipment') }}
                    </a>
                </li>
            @endif
            ...
            @if(($user->type === 'company' && in_array('manage equipments summary', $webAccess)) || ($user->type !== 'company' && $user->can('manage equipments summary')))
                <li class="dash-item {{ Request::routeIs('equipment.history.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('equipment.history.index') }}">
                        {{ __('Equipments Summary') }}
                    </a>
                </li>
            @endif
            ...
            @if(($user->type === 'company' && in_array('manage equipments reports', $webAccess)) || ($user->type !== 'company' && $user->can('manage equipments reports')))
                <li class="dash-item {{ Request::routeIs('equipment.report.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('equipment.report.index') }}">
                        {{ __('Equipments Report') }}
                    </a>
                </li>
            @endif
        </ul>
...
@endif
    ...
    <li class="dash-item dash-hasmenu {{ Request::is('attribute*','material-category*','material-analysis*') ? 'active dash-trigger' : '' }}">
        <a href="#!" class="dash-link">
            <span class="dash-micon"><i class="ti ti-report"></i></span>
            <span class="dash-mtext">{{ __('Material Reports') }}</span>
            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
        </a>
        ...
        <ul class="dash-submenu">
            ...
            @if(($user->type === 'company' && in_array('manage material units', $webAccess)) || ($user->type !== 'company' && $user->can('manage material units')))
                <li class="dash-item {{ request()->routeIs('attribute.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('attribute.index') }}">{{ __('Material Units') }}</a>
                </li>
            @endif

            {{-- Types Of Material --}}
            @if(($user->type === 'company' && in_array('manage types of material', $webAccess)) || ($user->type !== 'company' && $user->can('manage types of material')))
                <li class="dash-item {{ request()->routeIs('material-category.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('material-category.index') }}">{{ __('Types Of Material') }}</a>
                </li>
            @endif

            {{-- Material Record --}}
            @if(($user->type === 'company' && in_array('manage material record', $webAccess)) || ($user->type !== 'company' && $user->can('manage material record')))
                <li class="dash-item {{ request()->routeIs('material-analysis.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('material-analysis.index') }}">{{ __('Material Record') }}</a>
                </li>
            @endif
        </ul>
    </li>
...
@if(($user->type === 'company' && in_array('manage todo list', $webAccess)) || ($user->type !== 'company' && $user->can('manage todo list')))
    <li class="dash-item {{ request()->routeIs('to-do-list.index') ? 'active' : '' }}">
        <a class="dash-link" href="{{ route('to-do-list.index') }}">
            <span class="dash-micon"><i class="fas fa-tasks"></i></span>
            <span class="dash-mtext">{{ __('ToDo List') }}</span>
        </a>
    </li>
@endif
...
@if(($user->type === 'company' && in_array('manage work issue', $webAccess)) || ($user->type !== 'company' && $user->can('manage work issue')))
    <li class="dash-item {{ request()->routeIs('work-issue.index') ? 'active' : '' }}">
        <a class="dash-link" href="{{ route('work-issue.index') }}">
            <span class="dash-micon"><i class="fa fa-question-circle"></i></span>
            <span class="dash-mtext">{{ __('Work Issue') }}</span>
        </a>
    </li>
@endif
...
@if(($user->type === 'company' && in_array('manage site gallery', $webAccess)) || ($user->type !== 'company' && $user->can('manage site gallery')))
    <li class="dash-item {{ request()->routeIs('site-gallery.index') ? 'active' : '' }}">
        <a class="dash-link" href="{{ route('site-gallery.index') }}">
            <span class="dash-micon"><i class="fa fa-image"></i></span>
            <span class="dash-mtext">{{ __('Site Gallery') }}</span>
        </a>
    </li>
@endif
...
@if(
    ...
    ($user->type !== 'company' && (
        $user->can('manage holiday') ||
        $user->can('manage engineer attendance')
    ))
)
    <li class="dash-item dash-hasmenu
        {{ request()->routeIs('holiday.*') || request()->routeIs('engineer-attendance.*') ? 'active dash-trigger' : '' }}">
        ...
        <ul class="dash-submenu">
            ...
            @if(($user->type === 'company' && in_array('manage holiday', $webAccess)) || ($user->type !== 'company' && $user->can('manage holiday')))
                <li class="dash-item {{ request()->routeIs('holiday.index') ? 'active' : '' }}">
            ...
            @if(($user->type === 'company' && in_array('manage engineer attendance', $webAccess)) || ($user->type !== 'company' && $user->can('manage engineer attendance')))
                <li class="dash-item {{ request()->routeIs('engineer-attendance.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('engineer-attendance.index') }}">{{ __('Monthly Attendance') }}</a>
                </li>
            @endif
        </ul>
    </li>
...
@if(
    ...
    <li class="dash-item dash-hasmenu
        {{ request()->routeIs('site-report.*') ? 'active dash-trigger' : '' }}">

        <a href="#!" class="dash-link">
            <span class="dash-micon"><i class="fas fa-clipboard-list"></i></span>
            <span class="dash-mtext">{{ __('Site reports') }}</span>
            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
        </a>

        <ul class="dash-submenu">
            {{-- 🔹 Holiday --}}
            @if(($user->type === 'company' && in_array('manage site report', $webAccess)) || ($user->type !== 'company' && $user->can('manage site report')))
                <li class="dash-item {{ request()->routeIs('site-report.index') ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('site-report.index') }}">{{ __('Site reports') }}</a>
                </li>
            @endif
...
@endif
        ...
        @if (\Auth::user()->type == 'super admin')
            <ul class="dash-navbar">
                    ...
                    <li
                        ...
                        <a href="{{ route('users.index') }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-users"></i></span><span
                                class="dash-mtext">{{ __('Admin') }}</span>
                        </a>
                    </li>
                @endcan
                ...
                @can('manage user')
                    <li
                        class="dash-item dash-hasmenu {{ Request::route()->getName() == 'project.superadmin.index' || Request::route()->getName() == 'users.create' || Request::route()->getName() == 'users.edit' ? ' active' : '' }}">
                        <a href="{{ route('project.superadmin.index') }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-users"></i></span><span
                                class="dash-mtext">{{ __('Admin Project') }}</span>
                        </a>
                    </li>
                @endcan
