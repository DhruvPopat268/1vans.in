...
<div class="col-md-12 mb-6">
    {{ Form::label('file', __('Download sample Holiday CSV file'), ['class'=>'form-label']) }}
    <a href="{{ asset(Storage::url('uploads/sample/sample-holiday.csv')) }}" 
       class="btn btn-sm btn-primary" 
       download="sample-holiday.csv">
