...
<div class="modal-body">
    ...
    <li class="nav-item">
        <a class="nav-link" id="pills-project-document-tab" data-bs-toggle="pill" href="#project-document" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('Project Document') }}</a>
    </li>
@endif
...
@if(in_array('manage types of work', $webAccess) ||
    ...
    <li class="nav-item">
        <a class="nav-link" id="pills-project-management-tab" data-bs-toggle="pill" href="#project-management" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('Project Management') }}</a>
    </li>
@endif
...
@if(in_array('manage types of equipment', $webAccess) ||
    ...
    <li class="nav-item">
        <a class="nav-link" id="pills-equipment-management-tab" data-bs-toggle="pill" href="#equipment-management" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('Equipment Management') }}</a>
    </li>
@endif
...
@if(in_array('manage types of material', $webAccess) ||
    ...
    <li class="nav-item">
        <a class="nav-link" id="pills-material-reports-tab" data-bs-toggle="pill" href="#material-reports" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('Material Reports') }}</a>
    </li>
@endif

@if(in_array('manage todo list', $webAccess))
    <li class="nav-item">
        <a class="nav-link" id="pills-todo-list-tab" data-bs-toggle="pill" href="#todo-list" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('ToDo List') }}</a>
    </li>
@endif

@if(in_array('manage work issue', $webAccess))
    <li class="nav-item">
        <a class="nav-link" id="pills-work-issue-tab" data-bs-toggle="pill" href="#work-issue" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('Work Issue') }}</a>
    </li>
@endif

@if(in_array('manage site gallery', $webAccess))
    <li class="nav-item">
        <a class="nav-link" id="pills-site-gallery-tab" data-bs-toggle="pill" href="#site-gallery" role="tab" aria-controls="pills-home" aria-selected="false">{{ __('Site Gallery') }}</a>
    </li>
@endif
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                <h6 class="my-3">{{__('Assign Dashboard related Permission to Roles')}}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="dashboard_heckall"  id="dashboard_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck dashboard_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            <td><label class="ischeck dashboard_checkall" data-id="{{str_replace(' ', '', $module)}}">{{ ucfirst($module) }}</label></td>
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck dashboard_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                ...
                <div class="tab-pane fade" id="project-document" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                <h6 class="my-3">{{__('Assign Project Document related Permission to Roles')}}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="project-document_heckall"  id="project-document_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck project-document_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck project-document_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                 ...
                 <div class="tab-pane fade" id="project-management" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="project-management_heckall"  id="project-management_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck project-management_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    @if(in_array('add '.$module,(array) $permissions))
                                                        @if($key = array_search('add '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck project-management_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'Add',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                   ...
                   <div class="tab-pane fade" id="equipment-management" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="equipment-management_heckall"  id="equipment-management_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck equipment-management_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck equipment-management_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="material-reports" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="material-reports_heckall"  id="material-reports_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck material-reports_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck material-reports_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="todo-list" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        $modules=['todo list'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="todo-list_heckall"  id="todo-list_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck todo-list_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck todo-list_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                 ...
                 <div class="tab-pane fade" id="work-issue" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        $modules=['work issue'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="work-issue_heckall"  id="work-issue_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck work-issue_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck work-issue_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="site-gallery" role="tabpanel" aria-labelledby="pills-profile-tab">
                    @php
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="site-gallery_heckall"  id="site-gallery_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck site-gallery_checkall"  data-id="{{str_replace(' ', '', $module)}}" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    @if(in_array('view '.$module,(array) $permissions))
                                                        @if($key = array_search('view '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck site-gallery_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'View',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
