...
@section('page-title')
    {{ __('Manage Project Team Roles') }}
@endsection
@push('script-page')
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('Project Team Roles') }}</li>
@endsection
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="lg" data-url="{{ route('roles.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
            title="{{ __('Create New Project Team Role') }}" class="btn btn-sm btn-primary">
                                                    ...
                                                    @can('edit role')
                                                        <div class="action-btn me-2">
                                                            <a href="#"
                                                                ...
                                                                title="{{ __('Edit') }}"
                                                                data-title="{{ __('Project Team Role Edit') }}">
