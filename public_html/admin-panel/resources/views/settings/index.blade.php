                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="android_version" class="form-control" placeholder="e.g. 1.0.0" pattern="^\d+(\.\d+)+$" value="{{ optional($androidVersion)->version }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '')">
                                </div>

                                <div class="col-md-6">
                                    <label>Ios App Version</label>
                                    <input type="text" name="ios_version" class="form-control"  placeholder="e.g. 1.0" pattern="^\d+(\.\d+)+$" value="{{ optional($iosVersion)->version }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '')">
                                </div>
                            </div>

                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <label class="text-dark mb-1 mt-3">App Maintenance Mode (Android + iOS)</label>
                                    <div>
                                        <input type="checkbox" name="maintenance_mode" id="maintenance_mode" data-toggle="switchbutton" data-onstyle="primary" {{ (optional($androidVersion)->maintenance_mode || optional($iosVersion)->maintenance_mode) ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
