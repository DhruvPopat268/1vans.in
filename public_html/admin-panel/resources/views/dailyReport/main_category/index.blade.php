...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var savedPage = localStorage.getItem('now_page_main_category');
        if (savedPage) {
            localStorage.removeItem('now_page_main_category');
    ...
    $(document).on('submit', '#commonModal form', function (e) {
        ...
        if (action && action.includes('main-category')) {
            e.preventDefault();
            var form = $(this);
            ...
            localStorage.setItem('now_page_main_category', pageNum);
