...
<div class="modal-body">
    ...
    {{ Form::label('file', __('Download sample Engineer CSV file'), ['class' => 'form-label']) }}
    <a href="{{ Storage::url('uploads/sample/sample-engineer.csv') }}" class="btn btn-sm btn-primary" download="sample-engineer.csv">
